...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (defun rcoedo/layout/bottom-panel ()
    (interactive)
    (delete-other-windows)
    (rcoedo/window/split-bottom-panel))

  (defun rcoedo/layout/side-by-side ()
    (interactive)
    (delete-other-windows)
    (rcoedo/window/split-horizontally-next-buffer))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (req-package helm-dash
    ...
    :config
    (progn
      (add-to-list 'evil-insert-state-modes 'eww-mode)
  ...
  (req-package tern
    ...
    (progn
      ...
      (defun rcoedo/tern/bindings ()
        (rcoedo/evil-leader/set-mode-keys 'tern-mode
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (req-package js2-mode
    ...
    (add-hook 'js2-mode-hook (lambda ()
                               (rcoedo/evil-leader/set-mode-keys 'js2-mode
  ...
  (req-package go-mode
    ...
    (progn
      ...
      (defun rcoedo/go-mode/bindings ()
        (rcoedo/evil-leader/set-mode-keys 'go-mode
         '(("a" go-import-add)
           ("d" godef-describe)
           ("j" godef-jump)
  ...
  (req-package cider
    ...
    (progn
      ...
      (defun rcoedo/cider/hook ()
        (add-to-list 'evil-insert-state-modes 'cider-stacktrace-mode)
        (eldoc-mode t)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (define-key global-map (kbd "C-'")           'previous-multiframe-window)
