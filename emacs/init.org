...
#+BEGIN_SRC emacs-lisp :tangle yes
  (defun rcoedo/enable-minor-mode (my-pair)
    "Enable minor mode if it match the regexp.  MY-PAIR is a cons cell (regexp . minor-mode)."
    (if (buffer-file-name)
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (defun rcoedo/window/split-vertically-focus ()
    "Split the window vertically and then focus the new window."
    (interactive)
    (split-window-vertically)
    (other-window 1))

  (defun rcoedo/window/split-horizontally-focus ()
    "Split the window horizontally and then focus the new window."
    (interactive)
    (split-window-horizontally)
    (other-window 1))

  (defun rcoedo/window/split-vertically-focus-next-buffer ()
    "Split the window vertically, focus the new window and load next non Emacs buffer."
    (interactive)
  ...
  (defun rcoedo/window/split-horizontally-focus-next-buffer ()
    "Split the window horizontally, focus the new window and load next non Emacs buffer."
    (interactive)
  ...
  (defun rcoedo/window/split-bottom-panel ()
    "Split the window vertically to open a bottom panel."
    (interactive)
